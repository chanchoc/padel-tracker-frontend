...
export function CreateMatch() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await createMatch(formattedData);
            ...
            Toast.show({
                type: "success",
                text1: "Match created!",
                text2: "The match has been created successfully.",
                position: "top",
                visibilityTime: 1500,
            });
            refreshMatches();
            ...
            Toast.show({
                type: "error",
                text1: "Error",
                text2: "There was an error creating the match. Please try again.",
                position: "top",
                visibilityTime: 1500,
            });
        } finally {
    ...
    const handlePlayerCreated = (newPlayer) => {
        setPlayers((prevPlayers) => orderPlayersByName([...prevPlayers, newPlayer]));
    };
        ...
        return (
            <SafeAreaView className="flex-1 py-4 px-6 bg-background">
                ...
                >
                    ...
                    <Text className="text-surface font-poppins-bold text-lg">Create Match</Text>
                    <StyledPressable
    ...
    if (error) {
        return (
            <SafeAreaView className="flex-1 py-4 px-6 bg-background">
                ...
                {/* Error Message */}
                <ErrorMessage message={"Error loading create match"} classes={"py-0"} />
            </SafeAreaView>
        );
    }
